...
import heven.holt.lib_common.widget.refresh.ILoadMoreView;
...
public class SimpleLoadMoreView extends FrameLayout implements ILoadMoreView {
    ...
    public SimpleLoadMoreView(Context context, AttributeSet attrs) {
        super(context, attrs);
        view = inflate(context, R.layout.common_default_load_more, this);
        tvHitText = view.findViewById(R.id.tv_hit_content);
