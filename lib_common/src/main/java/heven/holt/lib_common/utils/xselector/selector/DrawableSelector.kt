...
class DrawableSelector private constructor() : ISelectorUtil<Drawable, View> {
    ...
    override fun into(view: View): XSelector {
        ...
        if (isSelectorColor) {
            try {
                (view as TextView).setTextColor(mColorStateList)
            } catch (e: Exception) {
                e.printStackTrace()
...
//    override fun intoCompoundDrawables(view: View) {
//        try {
//            val drawable = create()
//            drawable.setBounds(0, 0, drawable.minimumWidth, drawable.minimumHeight)
//            (view as TextView).setCompoundDrawables(drawable, null, null, null)
//        } catch (e: Exception) {
//            e.printStackTrace()
//            throw ExceptionInInitializerError("设置字体颜色选择器（Selector）请传入TextView（包括Button）！！！")
//        }
